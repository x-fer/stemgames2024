...
def get_puzzle():
    ...
    return {
        "uuid": uuid,
        "instructions": f"Within 10 seconds, solve https://cses.fi/problemset/task/{test_case['task']}." + " Then submit to /submit_solution/{uuid} with a post request with the solution to the test case given below in the body as json. Example: {'solution': '<your solution output>'}",
        "task": test_case["task"],
        "input": test_case["in"]
    }
